...
/**
 * @Description: 基于 httpclient 4.5.10版本的 http工具类
 * @Author: onnoA
...
public class HttpClientUtil {
    ...
    public static <T extends Object> HttpResult doPostReturnStateCode(String url, Map<String, T> params,
        ...
        LOGGER.info("http:post:request:url: {}, params:{}", url, params.toString());
        CloseableHttpResponse response = null;
        ...
        LOGGER.info("http:post:result:{}, {}", result.stateCode, result.content);
