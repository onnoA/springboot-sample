...
public class JWTUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ab = createJWT(new JWtObj().setId(1).setUsername("zh"), UuidUtil.getUUID(), JsonUtil.obj2Json(obj), JWTConstant.JWT_SECRET, 6000000);
        System.out.println(ab);
        JWtObj jWtObj = tranJWTObj(ab, JWTConstant.JWT_SECRET);
        Map<String, Object> userMap = BeanUtil.beanToMapInFields(obj, Arrays.asList("username"));
        userMap.put("token",ab);
        Map<String, Object> map = BeanUtil.beanToMap(jWtObj);
