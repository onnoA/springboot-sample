...
import com.onnoa.springcloud.alibaba.consumer.entity.TbUser;
import com.onnoa.springcloud.alibaba.consumer.utils.MapperUtils;
import com.onnoa.springcloud.alibaba.consumer.utils.PropertiesUtil;
...
public class EmailService {
    ...
    public void sendEmail(String subject, String body, String to) {
        ...
        message.setFrom(PropertiesUtil.getProperty("spring.mail.username"));
        message.setTo(to);
    ...
    public void sendTemplateEmail(String subject, String body, String to) {
        ...
        try {
            ...
            helper.setFrom(PropertiesUtil.getProperty("spring.mail.username"));
            helper.setTo(to);
